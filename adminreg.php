...
<div class="container mt-5" style="padding-top:80px;">
  <div class="row">
    <div class="col-sm-12">
        ...
        <form action="adminreg.php" name="registerForm" id="registerForm" method="post">
        ...
        <input type="tel" id="contact" name="contact" pattern="[0-9]{3} [0-9]{3} [0-9]{4}" maxlength="12" title="inter a valid number"required><br><br>
